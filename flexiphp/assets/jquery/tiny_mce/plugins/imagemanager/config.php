...
die(dirname(dirname(dirname(dirname(dirname(MCMANAGER_ABSPATH))));
  require_once(dirname(dirname(dirname(MCMANAGER_ABSPATH))) . "/public/api.php");
  ...
  die();
	...
	$mcImageManagerConfig['filesystem.path'] = APPLICATION_PATH . '/public/assets/'; // absolute or relative from this script path, optional.
